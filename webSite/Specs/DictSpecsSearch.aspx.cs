...
public partial class Specs_DictSpecsSearch : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        grdResult.DataKeyNames = new String[] { "ID" };
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        ...
        txtSequence_Search.Text = "";
        txtCheckPosition_Search.Text = "";
        txtCheckMethod_Search.Text = "";
        txtBarCode_Search.Text = "";
    ...
    protected void grdResult_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("DictSpecsEdit.aspx?id="+id.ToString());
    }
    #endregion
