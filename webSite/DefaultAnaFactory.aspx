<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="DefaultAnaFactory.aspx.cs" Inherits="DefaultAnaFactory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="False">
        ...
        <asp:TemplateField SortExpression="Area" HeaderText="供电段">
            ...
            <asp:TemplateField SortExpression="Area" HeaderText="供电车间">
                <ItemStyle Width="100px" />
                <ItemTemplate>
                    <asp:HyperLink ID="hlinkArea" runat="server" NavigateUrl='<%# "Default.aspx?Factory="+Eval("Factory") %>' Target="_top">
                        <asp:Label runat="server" Text='<%# Bind("Factory") %>' ID="lblArea" SkinID="" />
    ...
    <asp:Chart ID="Chart3" runat="server" Palette="Bright" Width="1024px">
        ...
        <ChartAreas>
            <asp:ChartArea Name="ChartArea1">
                <Area3DStyle Inclination="15" Rotation="45" /></asp:ChartArea>
        </ChartAreas>
    </asp:Chart>
    <br />
</asp:Content>
