...
public partial class Jobs_JobSearch2 : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        {
            Filter = Filter + " CheckType='接触网' ";
        }
        else
        {
            Filter = Filter + " CheckType='牵引变' ";
        }
