   ...
   <table width="1024px">
    ...
    <asp:GridView ID="grdDetails" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField SortExpression="Section" HeaderText="地址">
                <ItemStyle Width="100px" />
                <ItemTemplate>
            ...
            <asp:TemplateField SortExpression="Sequence" HeaderText="编号">
                <ItemStyle Width="100px" />
                <ItemTemplate>
                    <asp:Label runat="server" Text='<%# Bind("checkPointNo") %>' ID="lblSequence" SkinID="" />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField SortExpression="CheckPosition" HeaderText="检查项目">
                <ItemStyle Width="100px" />
                <ItemTemplate>
            ...
            <asp:TemplateField SortExpression="CheckDetailList" HeaderText="详细情况" Visible="false">
                <ItemStyle Width="100px" />
                <ItemTemplate>
            ...
            <asp:TemplateField SortExpression="CheckDetailList" HeaderText="详细情况">
