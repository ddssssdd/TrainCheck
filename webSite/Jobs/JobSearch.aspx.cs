...
public partial class Jobs_JobSearch : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        ddlArea_Search.DataSource = _Entity.Persistence.sql.ExecuteDataTable("select distinct area from dept");
        ddlArea_Search.DataValueField = "area";
        ddlArea_Search.DataTextField = "area";
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        ...
        ddlCheckType_Search.SelectedIndex = -1;
    ...
    {
        ddlFactory_Search.DataSource = _Entity.Persistence.sql.ExecuteDataTable(String.Format("select distinct factory from dept where area='{0}'",ddlArea_Search.Text));
        ddlFactory_Search.DataValueField = "factory";
        ddlFactory_Search.DataTextField = "factory";
    ...
    protected void ddlFactory_Search_SelectedIndexChanged(object sender, EventArgs e)
    {
        ddlSection_Search.DataSource = _Entity.Persistence.sql.ExecuteDataTable(
            String.Format("select distinct Section from dept where area='{0}' and factory='{1}'", ddlArea_Search.Text,ddlFactory_Search.Text));
        ddlSection_Search.DataValueField = "Section";
        ddlSection_Search.DataTextField = "Section";
